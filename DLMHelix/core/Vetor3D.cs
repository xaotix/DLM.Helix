...
namespace DLM.helix
{
    internal class Vetor3D
    {
        ...
        public Vetor3D(Matriz3D matriz, Enumeradores.eixo eixo)
        {
            switch(eixo)
            {
                case Enumeradores.eixo.X:
                    this.X = matriz.Xx;
                    this.Y = matriz.Xy;
                    this.Z = matriz.Xz;
                    break;
                case Enumeradores.eixo.Y:
                    this.X = matriz.Yx;
                    this.Y = matriz.Yy;
                    this.Z = matriz.Yz;
                    break;
                case Enumeradores.eixo.Z:
                    this.X = matriz.Zx;
                    this.Y = matriz.Zy;
                    this.Z = matriz.Zz;
                    break;
                case Enumeradores.eixo.XNeg:
                    this.X = -matriz.Xx;
                    this.Y = -matriz.Xy;
                    this.Z = -matriz.Xz;
                    break;
                case Enumeradores.eixo.YNeg:
                    this.X = -matriz.Yx;
                    this.Y = -matriz.Yy;
                    this.Z = -matriz.Yz;
                    break;
                case Enumeradores.eixo.ZNeg:
                    this.X = -matriz.Zx;
                    this.Y = -matriz.Zy;
                    this.Z = -matriz.Zz;
                    break;
        ...
        public NXOpen.Vector3d ToVector3d
        {
            get
            {
                return new NXOpen.Vector3d(this.X, this.Y, this.Z);
            }
        }
        ...
        public bool paralelo(Vetor3D vetor, Enumeradores.eixo ignorar = Enumeradores.eixo.nulo)
        {
            if(ignorar == Enumeradores.eixo.Z)
            {
        ...
        public bool Equals(object obj, Enumeradores.eixo ignorar = Enumeradores.eixo.nulo)
        {
            if(!(obj is Vetor3D)) return false;
            Vetor3D objComparado = (Vetor3D)obj;
            if(ignorar == Enumeradores.eixo.nulo)
            {
        ...
        public double angulo(Vetor3D vec, Enumeradores.eixo ignorar)
        {
            if(ignorar == Enumeradores.eixo.Z)
            {
            ...
            else if(ignorar == Enumeradores.eixo.X)
            {
                Vector vec1 = new Vector(this.Y, this.Z);
                Vector vec2 = new Vector(vec.Y, vec.Z);
                return Vector.AngleBetween(vec1, vec2);
            }
            else if(ignorar == Enumeradores.eixo.Y)
            {
        ...
        internal static Vetor3D Subtrair(Vetor3D v1, Util.Ponto3D v2)
        {
            Vetor3D vetor = new Vetor3D();
